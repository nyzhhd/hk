...
FreeYOLO::FreeYOLO(Net_config config)
{
	...
	{
		AllocatedStringPtr input_name_Ptr = ort_session->GetOutputNameAllocated(i, allocator);
		input_names.push_back(input_name_Ptr.get());
...
int main222()
{
	Net_config cfg = { 0.6, 0.5, "D:\adavance\yolo_free_huge_crowdhuman_192x320.onnx", "person" };
	FreeYOLO net(cfg);
